...
{
    [Serializable]
    public class OrientationConstraintsMsg : Message
    {
        public const string k_RosMessageName = "remote_control/OrientationConstraints";
        ...
        public OrientationConstraintsMsg()
        {
        ...
        public OrientationConstraintsMsg(Std.HeaderMsg header, Geometry.QuaternionMsg orientation, string link_name, double absolute_x_axis_tolerance, double absolute_y_axis_tolerance, double absolute_z_axis_tolerance, double weight)
        {
            this.header = header;
        ...
        public static OrientationConstraintsMsg Deserialize(MessageDeserializer deserializer) => new OrientationConstraintsMsg(deserializer);

        private OrientationConstraintsMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "OrientationConstraintsMsg: " +
